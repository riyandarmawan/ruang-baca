    ...
    <div class="h-full p-4">
        <div x-data="{ activatedTab: window.location.hash || '#profile', showModalHapus: false }" class="ms-auto h-full rounded bg-white p-4 shadow">
            <ul class="mb-4 flex border-b border-slate-200">
                <li><a href="#profile" @click="activatedTab = '#profile'"
                        :class="activatedTab === '#profile' ? 'tab-active' : 'tab-inactive'"
                        class="cursor-pointer rounded-tl rounded-tr border border-b-0 px-4 py-2 font-medium inline-block">Profile</a>
                </li>
                <li><a href="#ubah" @click="activatedTab = '#ubah'"
                        :class="activatedTab === '#ubah' ? 'tab-active' : 'tab-inactive'"
                        class="cursor-pointer rounded-tl rounded-tr border border-b-0 px-4 py-2 font-medium inline-block">Ubah</a>
                </li>
                <li><a href="#ubah-password" @click="activatedTab = '#ubah-password'"
                        :class="activatedTab === '#ubah-password' ? 'tab-active' : 'tab-inactive'"
                        class="cursor-pointer rounded-tl rounded-tr border border-b-0 px-4 py-2 font-medium inline-block">Ubah
                        Password</a></li>
                <li><a href="#hapus" @click="activatedTab = '#hapus'"
                        :class="activatedTab === '#hapus' ? 'tab-active' : 'tab-inactive'"
                        class="cursor-pointer rounded-tl rounded-tr border border-b-0 px-4 py-2 font-medium inline-block">Hapus</a>
                </li>
            </ul>
            ...
            <div x-cloak x-show="activatedTab === '#ubah'">
                <form action="/dashboard/user/ubah/{{ Auth::user()->username }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4 grid grid-cols-4 items-center">
                        ...
                        @error('name')
                            <p class="col-span-3 col-start-2 mt-2.5 text-sm font-medium text-red-500">{{ $message }}
                            </p>
                        @enderror
                    </div>
                    <div class="mb-4 grid grid-cols-4 items-center">
                    ...
                    <button
                        class="col-span-4 mt-2 w-full rounded bg-tersier hover:opacity-80 focus:opacity-70 px-4 py-2 text-center font-medium text-white shadow">Ubah</button>
                </form>
            </div>
                ...
                <form action="/dashboard/user/ubah-password/{{ Auth::user()->username }}" method="POST">
                    ...
                    <div x-data="{ showPassword: false }" class="mb-4 grid grid-cols-4 items-center">
                        ...
                        <div class="relative col-span-3">
                            <input :type="showPassword ? 'text' : 'password'" id="oldPassword" name="oldPassword" required
                    ...
                    <div x-data="{ showPassword: false }" class="mb-4 grid grid-cols-4 items-center">
                        <label for="password_confirmation" class="col-span-1 font-medium text-slate-500">Konfirmasi
                            Password</label>
                        <div class="relative col-span-3">
                    ...
                    <button
                        class="col-span-4 mt-2 w-full rounded bg-tersier hover:opacity-80 focus:opacity-70 px-4 py-2 text-center font-medium text-white shadow">Ubah
                        Password</button>
                </form>
            </div>
