<x-dashboard.layout title="{{ $title }}">
    <div class="grid grid-cols-3 gap-8 p-4">
        ...
        <div class="rounded-md border-2 border-primary bg-primary p-4 text-background">
            <h4 class="text-center text-xl font-medium">Jumlah buku yang masih dipinjam</h4>
            <h2 id="data-pinjam" class="mt-4 text-center text-5xl font-bold">{{ $jumlahBukuYangMasihDiPinjam }}</h2>
        </div>
